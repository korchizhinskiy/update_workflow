...
from app.core.application.exceptions import ApplicationError, ProjectNotFoundError
...
def setup_exception_handlers(app: FastAPI) -> None:
    app.add_exception_handler(ProjectNotFoundError, error_handler(status.HTTP_404_NOT_FOUND))
